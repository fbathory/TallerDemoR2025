...
- También podemos leer extensiones *.dbf*, *SAS*, *SPSS*, *Stata*, etcéteras... gracias a la librería [foreign](https://cran.r-project.org/package=foreign). Por ejemplo, una base de datos del entorno SPSS de la EPH del segundo trimestre de 2023:
...
sum(DEf05_22$cantidad[DEf05_21$anio == 2021])
sum(DEf05_22$cantidad[DEf05_21$anio == 2021 & DEf05_22$sexo_id == 1])
sum(DEf05_22$cantidad[DEf05_21$anio == 2021 & DEf05_22$jurisdiccion_de_residencia_id == 82])
```
