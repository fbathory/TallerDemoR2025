...
CABA <- read_sf("data/Codgeo_pais/pxdptodatosok.shp") |> 
...
En esta clase veremos cómo crear un archivo `.qmd`, cómo incorporar código R, cómo generar distintos formatos de salida y cómo preparar un informe reproducible aplicado a análisis demográfico.


*Quarto* es una herramienta para crear documentos reproducibles que combinan texto, código y resultados. Sus componentes principales son:

**Autoría (Author):**  
Permite escribir y combinar texto y código en archivos `.qmd` o en cuadernos Jupyter, utilizando una sintaxis Markdown ampliada que facilita la organización del contenido.

**Renderizado (Render):**  
A partir del mismo archivo fuente, es posible generar diferentes tipos de salidas: documentos HTML, PDF o Word, presentaciones (reveal.js, PowerPoint, Beamer), así como sitios web, blogs o libros.

**Compartir (Share):**  
Los documentos generados pueden publicarse o alojarse en diversas plataformas, como GitHub Pages, Netlify, Quarto Pub, Posit Cloud o Posit Connect, según las necesidades del proyecto.



```{r, echo=F}
include_graphics("figs/quarto.png")
```


Quarto permite crear:
...
* [Hoja de Ayuda R Markdown](https://raw.githubusercontent.com/rstudio/cheatsheets/main/translations/spanish/rmarkdown_es.pdf)

* [De su creador](https://bookdown.org/yihui/rmarkdown/)

* [Hoja de Ayuda Quarto](https://rstudio.github.io/cheatsheets/quarto.pdf)

* [Guía para utilizar Quarto (en inglés)](https://quarto.org/docs/guide/)