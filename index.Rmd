...
¡Bienvenidxs de nuevo! `r fa("face-smile")`

Este sitio web contiene los materiales para las clases del Taller de R aplicado al Análisis Demográfico del programa de maestría y especialización en Demografía Social ofrecido en la Universidad Nacional de Luján. **No** es una guía autoexplicada, sino un acompañamiento y soporte para la cursada.

Algunas cosas útiles:

-   Encuentra el código fuente de este sitio en [GitHub](https://github.com/fbathory/TallerDemoR2025/tree/master).
...
Les dejamos los enlaces de descarga, en caso de que necesiten volver a descargar:

-    [R](http://mirror.fcaglp.unlp.edu.ar/CRAN/) `r fa("r-project")`. Como chequeo, la última versión es la **`r installr::get_latest_r_version()`**.

-   [RStudio](https://www.rstudio.com/products/rstudio/download/) `r fa("registered")`. Un video muy ilustrativo del proceso de instalación es [este](https://www.youtube.com/watch?v=Nmu4WPdJBRo)[^index-1][^index-2].

[^index-1]: A lo largo de este taller nos valdremos de contenido realizado por muuuchas personas. Una práctica que nos gustaría contagiarte: si nos aporta, démosle *like* y/o compartamos y/o dejémos algún feedback si es posible.

[^index-2]: Créditos: los materiales de estas clases (incluyendo memes) fueron inicialmente mentados y desarrollados por [Iván Williams](https://github.com/IvanWilli).
...
### Materiales anteriores y otras cosas a tener a mano

Todos los materiales de las iniciales de Análisis Demográfico III se encuentran en este [link](https://fbathory.github.io/TallerDemoR/)

Cheat sheet de [tidyr](https://tidyr.tidyverse.org/). 

Cheat sheet de [dplyr](https://dplyr.tidyverse.org/).

Cheat sheet de [ggplot2](https://ggplot2.tidyverse.org/).
...
include_graphics("figs/cat_coding.gif")
```
