...
theme_void() +
labs(title = "Hogares sin acceso a la red cloacal (2022)",
caption = "Fuente: INDEC")
...
labs(title = "Hogares sin red cloacal por provincia (2022)",
caption = "Fuente: INDEC")
...
Por último, para incluir el mapa en informes, presentaciones o enviarlo a otras
personas, podemos exportarlo directamente desde R con *ggsave()*.
Esta función guarda el último gráfico o el objeto gráfico que indiquemos,
con tamaño y resolución ajustables.


```{r save}
ggsave("mapa_cloaca.png",
p_cloaca,
