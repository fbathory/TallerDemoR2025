...
Los datos los podés encontrar en el archivo que usamos para Myers y Whipple o en [la web](https://censo.gob.ar/index.php/datos_definitivos/). 
...
En un primer chunk debes leer los datos censales directo desde R. Si utilizás los datos de INDEC, en todos los casos usá el archivo xlsx referido al Cuadro 4, que contiene la población por sexo y edad.
...
Luego agregar:
  ...
  - Mostrar un mapa provincial con un indicador a elección según departamento (necesario cargar un shapefile con los límites de departamento o radios censales). Sugerimos seleccionar indicadores simples con la información disponible (Ej: porcentaje de mujeres, proporción de población 65+, índice de dependencia, razón de sexos, etc). Es necesario unir la capa geográfica con el indicador mediante `left_join` y luego visualizar el mapa.
